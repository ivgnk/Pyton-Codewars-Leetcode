...
# Runtime 126 ms Beats 84.85% of users with Python
# Memory 12.25 MB Beats 52.53% of users with Python
...
def countGoodRectangles(rectangles):
    ...
    :rtype: int
    """
    ml=[min(i) for i in rectangles]
    m=max(ml)
    return len([i for i in ml if i==m])
