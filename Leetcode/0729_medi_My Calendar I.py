"""
729. My Calendar I. Topics: Array, Binary Search
...
# Runtime 510 ms Beats 19.70%
# Memory 17.26 MB Beats 83.27%
class MyCalendar:
    def __init__(self):
        self.data=[]

    def book(self, start: int, end: int) -> bool:
        for (st_,en_) in self.data:
            if ((st_<=start<en_) or (st_<end<=en_)) or ((start<st_) and (en_<end)):
                return False
