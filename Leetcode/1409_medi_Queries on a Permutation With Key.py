"""
Done 17.05.2024. Topics: Array, Binary Indexed Tree, Simulation
...
# Runtime 35 ms Beats 57.14% of users with Python
# Memory 11.76 MB Beats 71.43% of users with Python
# Runtime 21 ms Beats 100.00% of users with Python
# Memory 11.98 MB Beats 19.05% of users with Python
