"""
Done 06.09.2024. Topics: Array, Prefix Sum
...
"""
# based on
# https://leetcode.com/problems/minimum-value-to-get-positive-step-by-step-sum/description/comments/1574871
def minStartValue(nums):
    """
    :type nums: List[int]
    :rtype: int
    """
    mmin=00000 # Чтобы ответ всегда был положительным
