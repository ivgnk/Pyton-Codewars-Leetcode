...
More formally, an attack at second t will mean Ashe
...
# Runtime 179 ms Beats 75.12% of users with Python
# Memory 12.88 MB Beats 59.02% of users with Python
...
print(findPoisonedDuration(timeSeries = [1,2], duration = 2))