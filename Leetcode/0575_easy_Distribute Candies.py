"""
Done 07.08.2024. Topics: Array, Hash Table
...
Hint 2
What is the upper limit of the number of kinds of candies sister will gain?
Remember candies are to distributed equally.
Hint 3
Which data structure is the most suitable for finding the number of kinds of candies?
Hint 4
Will hashset solves the problem?
Inserting all candies kind in the hashset and then checking its size with upper limit.
"""

# Runtime 602 ms Beats 86.26%
# Memory 13.58 MB Beats 79.48%
def distributeCandies(candyType):
    """
    :type candyType: List[int]
    :rtype: int
    """
    ls = len(set(candyType))
    ll = len(candyType) // 2
    return min(ll, ls)