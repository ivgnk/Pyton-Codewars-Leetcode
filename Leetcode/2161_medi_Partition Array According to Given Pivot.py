...
"""
# Runtime 1057 ms Beats 79.87% of users with Python
# Memory 30.04 MB Beats 32.89% of users with Python
# Runtime 1055 ms Beats 82.55% of users with Python
# Memory 30.18 MB Beats 21.48% of users with Python
...
def pivotArray(nums, pivot):
    ...
    :rtype: List[int]
    """
    lm = [i for i in nums if i<pivot]
    le = [i for i in nums if i==pivot]
    lb = [i for i in nums if i>pivot]
    return lm+le+lb
