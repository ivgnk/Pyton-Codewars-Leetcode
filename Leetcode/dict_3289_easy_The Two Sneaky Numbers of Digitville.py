"""
Done 16.09.2024. Topics: Hash Map
...
To solve the problem without the extra space, we need to think about how many times each number
occurs in relation to the index.

Solution
✏️ Easy Python solution with dictionary

Intuition
Why invent something if Python has a dictionary for such tasks.

Approach
Use dictionary.
And list comprehension for make resultю
"""
